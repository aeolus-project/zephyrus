...
module Location_component_type_map : Data_common.Map.S with type key = Data_model.location_name * Data_model.component_type_name
module Location_package_map : Data_common.Map.S with type key = Data_model.location_name * Data_model.package_name

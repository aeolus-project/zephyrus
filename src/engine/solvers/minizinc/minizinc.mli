...
val core_translation : named_variables -> variable_bounds -> Data_state.structured_constraints -> structured_minizinc

val add_optimization_goal : structured_minizinc -> expression Single_objective.solve_goal -> minizinc

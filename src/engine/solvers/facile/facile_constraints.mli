...
module Facile_constraints :
  sig
    ...
    val translate_var  : facile_variables -> Constraints.var  -> var
	val translate_expr : facile_variables -> Constraints.expr -> expr
	val translate_cstr : facile_variables -> Constraints.cstr -> cstr

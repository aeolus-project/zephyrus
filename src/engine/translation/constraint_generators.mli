...
val conflict_advanced              : port_ids:Port_id_set.t -> get_conflicters:(port_id -> Component_type_id_set.t) -> get_providers:(port_id -> Component_type_id_set.t)                               -> konstraint list

...
val requirers                               : universe -> port_name -> component_type list
...
val providers                               : universe -> port_name -> component_type list
...
val conflicters                             : universe -> port_name -> component_type list

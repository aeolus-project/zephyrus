...
my_data = matplotlib.mlab.csv2rec("tuesday_evening_aggregated_corrected.csv")
	...
	for optionmysqlprovide in [3,4]:
		...
		for solver in ["g12", "gecode"]:
			for optionwebservers in [0,1,2,3,4,5]:
				...
				ax = fig.add_subplot(2, 6, 1 + optionwebservers + (solver_indices[solver] * 6), projection='3d')
				...
				ax.set_yticks([0,1,10,20,40,60,80,100])
